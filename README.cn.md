...
[![x-cmd/install — aria2 Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/aria2.svg?lang=zh)](https://x-cmd.com/install/aria2)
...
- **Star**: 42,644 · **Fork**: 3,929 · **开放 issue**: 1,944 · **贡献者**: 64

## 累计统计

- **发布数**: 24 · **已合并 PR**: 258 · **开放 PR**: 64 · **已关闭 issue**: 830 · **开放 issue**: 1114 · **提交数**: 5447
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/aria2.yml>（或索引实际使用的路径）
